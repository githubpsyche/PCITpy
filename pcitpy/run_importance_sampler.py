...
# %% markdown
# ## Testing
# `run_importance_sampler` is designed to be modified to specify P-CIT parameters before execute. We produce customized version of the function (`eval_run_importance_sampler`) that alters where data is sourced from into `data/test/test.m`
#
