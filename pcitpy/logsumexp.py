...
# %% markdown
# ## Testing
# Here we assume that `scipy.special`'s `logsumexp` already implements the full function.
# To test the function, we use an example from the function's documentation and compare output between versions.
