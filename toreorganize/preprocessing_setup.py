...
# %%
def scramble_dependent_variable(target_dependent_variables, target_net_effect_clusters, testing=False):
...
# We use the example variables provided in the comments of the original matlab function:
...
def test_scramble_dependent_variable(target_dependent_variables=None, target_net_effect_clusters=None):
    print('testing scramble_dependent_variable...')
    ...
    # generate output
    python_output = scramble_dependent_variable(
        target_dependent_variables, target_net_effect_clusters, True)
    matlab_output = np.asarray(eng.eval_scramble_dependent_variable(
        matlab.int32(target_dependent_variables), matlab.double(target_net_effect_clusters)))
...
if __name__ == '__main__':
    ...
    test_scramble_dependent_variable()
